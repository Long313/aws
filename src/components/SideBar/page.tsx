        ...
        <div className="py-[10px]">
          <div className="text-white">
            ...
            >
              ...
              >
                <span className="min-w-[30px] inline-block">
                  <span className="min-w-[24px] inline-block">1.</span> Giới
                  thiệu
                </span>
              ...
              <ul>
                ...
                >
                  <Link href={`/work_shop/${id}/ec2-and-auto-scaling-group`}>
                    <span className="min-w-[24px] inline-block">1.1</span> EC2
                    và Auto Scaling Group
                  </Link>
                </li>
                <li
                ...
                >
                  <Link href={`/work_shop/${id}/vpc`}>
                    <span className="min-w-[24px] inline-block">1.2</span>{" "}
                ...
                >
                  <Link href={`/work_shop/${id}/subnets`}>
                    <span className="min-w-[24px] inline-block">1.3</span>{" "}
                    Subnets
                  </Link>
                </li>
                <li
                ...
                >
                  <Link href={`/work_shop/${id}/elb`}>
                    <span className="min-w-[24px] inline-block">1.5</span>{" "}
            ...
            >
              ...
              >
                <span className="min-w-[30px] inline-block">
                  <span className="min-w-[24px] inline-block">2.</span> Tường
                  lửa trong VPC
                </span>
                <span className="inline-block mr-[4px]">&#9660;</span>
              </Link>
              ...
              <ul>
                ...
                >
                  <Link href={`/work_shop/${id}/nacls`}>
                    <span className="min-w-[24px] inline-block">2.2</span>{" "}
            ...
            >
              ...
              >
                <span className="min-w-[30px] inline-block">
                  <span className="min-w-[30px] inline-block">4.</span>Tạo máy
                  chủ EC2
                </span>
                <span className="inline-block mr-[4px]">&#9660;</span>
              </Link>
              ...
              <ul>
                ...
                >
                  <Link href={`/work_shop/${id}/check-connect`}>
                    <span className="min-w-[30px] inline-block">4.2</span>Kiểm
                    tra kết nối
                  </Link>
                </li>
                <li
                ...
                >
                  <Link href={`/work_shop/${id}/create-nat-gateway`}>
                    <span className="min-w-[20px] inline-block">4.3</span> Tạo
                    NAT Gateway
                  </Link>
                </li>
                <li
                ...
                >
                  <Link href={`/work_shop/${id}/reachability-analyzer`}>
                    <span className="min-w-[30px] inline-block">4.4</span>Sử
                    dụng Reachability Analyzer
                  </Link>
                </li>
                <li
                ...
                <li
                  onClick={() =>
                    handleSelect("create-application-load-balancer")
                  }
                  className={`${
            ...
            >
              ...
              >
                <span className="min-w-[30px] inline-block">
                  <span className="min-w-[30px] inline-block">5.</span>Tạo các
                  tài nguyên khác
                </span>
                <span className="inline-block mr-[4px]">&#9660;</span>
              </Link>
            ...
            >
              <ul>
                <li
                  ...
                  className={`${
                    selectedId === "create-rds" || subMenuId === "create-rds"
                      ? "bg-white text-black"
                      : "black"
                  } px-[5px]`}
                >
        ...
        <div className="py-[10px]">
          <div className="text-white">
            ...
            <div
              onClick={() => {
                handleToggleMenu(11);
                handleSelect("introduce_deploy_nestjs");
              }}
              className={`${
                selectedId === "introduce_deploy_nestjs" || subMenuId === "introduce_deploy_nestjs"
                  ? "bg-white text-black"
                  : "black"
              } flex justify-between items-center`}
            >
              <Link
                href={`/work_shop/${id}/introduce_deploy_nestjs`}
                className="flex justify-between text-[18px] p-[4px] w-full"
              >
                <span className="min-w-[30px] inline-block">
                  <span className="min-w-[24px] inline-block">1.</span> Giới
            ...
            >
              <ul>
                <li
                  onClick={() => handleSelect("introduce_nestjs")}
                  className={`${
                    selectedId === "introduce_nestjs" ||
                    subMenuId === "introduce_nestjs"
                      ? "bg-white text-black"
                      : "black"
                  } px-[5px]`}
                >
                  <Link href={`/work_shop/${id}/introduce_nestjs`}>
                    <span className="min-w-[24px] inline-block">1.1</span> Giới thiệu về NestJS
                  </Link>
                </li>
                <li
                  onClick={() => handleSelect("introduce_mindset_deploy")}
                  className={`${
                    selectedId === "introduce_mindset_deploy" || subMenuId === "introduce_mindset_deploy"
                      ? "bg-white text-black"
                      : "black"
                  } px-[5px]`}
                >
                  <Link href={`/work_shop/${id}/introduce_mindset_deploy`}>
                    <span className="min-w-[24px] inline-block">1.2</span>{" "}
                ...
                >
                  <Link href={`/work_shop/${id}/nat-gateway`}>
                    <span className="min-w-[24px] inline-block">1.5</span> NAT
                    Gateway
                  </Link>
                </li>
              </ul>
            ...
            >
              <ul>
                ...
                >
                  <Link href={`/work_shop/${id}/ec2-and-auto-scaling-group`}>
                    <span className="min-w-[24px] inline-block">1.3</span> EC2
                    và Auto Scaling Group
                  </Link>
                </li>
                <li
